...
// import { type IDecodedData, type IRawAction, KnownActionSignature, type NetworksEnum } from '@types'
...
//   }
//
//   async _decodeWithAbi(action: IRawAction, document: Partial<Proposal>): Promise<IDecodedData | null> {
...
//               textSignature,
//               decoded: decodedFormatted,
//               contractName: contractNetspec.contractName,
...
//         contract: decodedData.contractName,
