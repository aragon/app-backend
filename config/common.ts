  ...
  return {
    ...
    NODES: {
      ...
      POLYGON_MAINNET: {
        ...
        OFFSET_TO_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_POLYGON_MAINNET_OFFSET_TO_BLOCK', 0),
        POOLING_INTERVAL: utils.configParser(
          sourceConfig,
          'number',
      ...
      ARBITRUM_MAINNET: {
        ...
        OFFSET_TO_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_ARBITRUM_MAINNET_OFFSET_TO_BLOCK', 0),
        POOLING_INTERVAL: utils.configParser(
          sourceConfig,
          'number',
      ...
      CHILIZ_MAINNET: {
        ...
        FROM_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_CHILIZ_MAINNET_FROM_BLOCK', 0),
        OFFSET_TO_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_CHILIZ_MAINNET_OFFSET_TO_BLOCK', 0),
        POOLING_INTERVAL: utils.configParser(sourceConfig, 'number', 'NODES_CHILIZ_MAINNET_POOLING_INTERVAL', 5 * 1000), // 5 seconds
        ...
        BLOCKSCOUT_API_URL: utils.configParser(
          sourceConfig,
          'string',
          'NODES_CHILIZ_MAINNET_BLOCKSCOUT_API_URL',
      ...
      CORN_MAINNET: {
        ...
        FROM_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_CORN_MAINNET_FROM_BLOCK', 0),
        OFFSET_TO_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_CORN_MAINNET_OFFSET_TO_BLOCK', 0),
        POOLING_INTERVAL: utils.configParser(sourceConfig, 'number', 'NODES_CORN_MAINNET_POOLING_INTERVAL', 12 * 1000),
        ...
        BLOCKSCOUT_API_URL: utils.configParser(sourceConfig, 'string', 'NODES_CORN_MAINNET_BLOCKSCOUT_API_URL', null),
