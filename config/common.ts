  ...
  return {
    ...
    NODES: {
      ...
      AVAX_MAINNET: {
        ...
        OFFSET_TO_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_AVAX_MAINNET_OFFSET_TO_BLOCK', 4),
        POOLING_INTERVAL: utils.configParser(sourceConfig, 'number', 'NODES_AVAX_MAINNET_POOLING_INTERVAL', 2 * 1000),
        CONFIRMATION_BLOCKS: utils.configParser(sourceConfig, 'number', 'NODES_AVAX_MAINNET_CONFIRMATION_BLOCKS', 3),
