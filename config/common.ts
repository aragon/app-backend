  ...
  return {
    ...
    NODES: {
      ...
      BASE_MAINNET: {
        ...
        POOLING_INTERVAL: utils.configParser(sourceConfig, 'number', 'NODES_BASE_MAINNET_POOLING_INTERVAL', 3 * 1000), // 3 seconds
      ...
      MONAD_MAINNET: {
        ...
        OFFSET_TO_BLOCK: utils.configParser(sourceConfig, 'number', 'NODES_MONAD_MAINNET_OFFSET_TO_BLOCK', 2),
        POOLING_INTERVAL: utils.configParser(sourceConfig, 'number', 'NODES_MONAD_MAINNET_POOLING_INTERVAL', 3 * 1000),
