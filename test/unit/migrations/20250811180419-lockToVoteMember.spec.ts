...
describe.only('migration: lockToVoteMember', () => {
  ...
  describe('lockToVoteMemberMigration with real database', () => {
    ...
    it('should handle errors gracefully and continue processing', async () => {
      ...
      const validLockMember = lockManagerMembers.find((lm: any) => lm.memberAddress === '0x17366cae2b9c6C3055e9e3C78936a69006BE5409')
      ...
      const validDoc = oldDocuments.find((doc: any) => doc.memberAddress === '0x17366cae2b9c6C3055e9e3C78936a69006BE5409')
