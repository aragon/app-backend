...
describe('Helpers: DecodeActions', () => {
  ...
  describe('_setupSignatures', () => {
    it('should set up signatures correctly', () => {
      ...
      expect(allSignatures[4].contractName).to.eq('IERC20MintableUpgradeable')
      expect(allSignatures[5].contractName).to.eq('ERC20')
      expect(allSignatures[6].contractName).to.eq('ERC721')
      expect(allSignatures[7].contractName).to.eq('ERC1155')
      expect(allSignatures[8].contractName).to.eq('GovernanceERC20')
      expect(allSignatures[9].contractName).to.eq('DAO')
      expect(allSignatures[10].contractName).to.eq('PluginRepo')
      expect(allSignatures[11].contractName).to.eq('PluginRepoFactory')
      expect(allSignatures[12].contractName).to.eq('PluginRepoRegistry')
      expect(allSignatures[13].contractName).to.eq('DAORegistry')
      expect(allSignatures[14].contractName).to.eq('MultiSigSetup')
      expect(allSignatures[15].contractName).to.eq('AddresslistVoting')
    })
  })
