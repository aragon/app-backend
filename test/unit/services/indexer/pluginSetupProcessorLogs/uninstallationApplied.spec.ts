...
describe('Indexer: PluginLogsUninstallationApplied', () => {
  ...
  describe('start', () => {
    it('should start', async () => {
      ...
      const processMetadataStub = sandbox.stub(PluginLogsUninstallationApplied, 'processLog').resolves()
    ...
    it('should start handle error', async () => {
      ...
      const processMetadataStub = sandbox.stub(PluginLogsUninstallationApplied, 'processLog').rejects()
      const errorStub = sandbox.stub(PluginLogsUninstallationApplied, 'processError').resolves()
      const loggerVerboseStub = sandbox.stub(logger, 'verbose')
      const saveSyncStub = sandbox.stub(UtilsIndexer, 'saveSync').resolves()
  ...
  it('processLog', async () => {
    ...
    await PluginLogsUninstallationApplied.processLog(txLog, NetworksEnum.mainnet)
