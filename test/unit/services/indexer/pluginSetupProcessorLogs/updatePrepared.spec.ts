...
describe('Indexer: PluginLogsUpdatePrepared', () => {
  ...
  describe('start', () => {
    it('should start', async () => {
      ...
      const processMetadataStub = sandbox.stub(PluginLogsUpdatePrepared, 'processLog').resolves()
    ...
    it('should start handle error', async () => {
      ...
      const processMetadataStub = sandbox.stub(PluginLogsUpdatePrepared, 'processLog').rejects()
      const errorStub = sandbox.stub(PluginLogsUpdatePrepared, 'processError').resolves()
      const loggerVerboseStub = sandbox.stub(logger, 'verbose')
      const saveSyncStub = sandbox.stub(UtilsIndexer, 'saveSync').resolves()
  ...
  it('processLog', async () => {
    ...
    await PluginLogsUpdatePrepared.processLog(txLog, NetworksEnum.mainnet)
