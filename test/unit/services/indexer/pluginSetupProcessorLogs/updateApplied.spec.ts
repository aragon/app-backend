...
describe('Indexer: PluginLogsUpdateApplied', () => {
  ...
  describe('start', () => {
    it('should start', async () => {
      ...
      const processMetadataStub = sandbox.stub(PluginLogsUpdateApplied, 'processLog').resolves()
    ...
    it('should start handle error', async () => {
      ...
      const processMetadataStub = sandbox.stub(PluginLogsUpdateApplied, 'processLog').rejects()
      const errorStub = sandbox.stub(PluginLogsUpdateApplied, 'processError').resolves()
      const loggerVerboseStub = sandbox.stub(logger, 'verbose')
      const saveSyncStub = sandbox.stub(UtilsIndexer, 'saveSync').resolves()
  ...
  it('processLog', async () => {
    ...
    await PluginLogsUpdateApplied.processLog(txLog, NetworksEnum.mainnet)
